...
# Objetivo: Calcular Y[i] = A * X[i] + B eliminando riesgos de datos mediante reordenamiento.
# VERSIÓN OPTIMIZADA: Instrucción independiente intercalada para reducir stalls
...
loop:
    ...
    # --- Carga de dato ---
    lw $t6, 0($t5)        # Leer X[i]
    # OPTIMIZACIÓN: Intercalamos instrucción independiente aquí
    addu $t9, $s1, $t4    # t9 = dirección de Y[i] (NO depende de $t6)

    # --- Operación aritmética ---
    mul $t7, $t6, $t0     # t7 = X[i] * A  (menos stall ahora)
